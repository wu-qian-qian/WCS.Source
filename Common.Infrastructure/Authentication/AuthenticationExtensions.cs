...
namespace Common.Infrastructure.Authentication
{
    public static class AuthenticationExtensions
    {
        ...
        /// <returns></returns>
        public static AuthenticationBuilder AddJwtAuthenticationConfiguration(this IServiceCollection services, JWTOptions options)
        {
            ...
            return services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
                .AddJwtBearer(jwt => {
                    jwt.TokenValidationParameters = new Microsoft.IdentityModel.Tokens.TokenValidationParameters 
                    {
                        ...
                        IssuerSigningKey = new SymmetricSecurityKey(key: Encoding.UTF8.GetBytes(s: options.Key)),
        ...
        /// <param name="services"></param>
        /// <returns></returns>
        public static IServiceCollection AddJwtAuthenticationConfigurationoptions(this IServiceCollection services, JWTOptions options)
        {
            services.Configure<SwaggerGenOptions>(c =>
            {
                c.AddAuthenticationHeader();
